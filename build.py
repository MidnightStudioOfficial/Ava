...
#os.system("pyinstaller --collect-all chatterbot --collect-all comtypes --collect-all blis --collect-all pywin32_system32 --collect-all win32comext --collect-all spacy --collect-all sklearn --collect-all win32com --collect-all win32ctypes --distpath ./bin ./src/main.py")
