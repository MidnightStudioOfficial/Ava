...
class Layout:
    def __init__(self: object, parent: Tk, absolute_path: str) -> object:
        ...
        self.tree_open = PhotoImage(
            file=join(self.abs_path, r'Data\Resources2\plus.png'))
        self.tree_close = PhotoImage(
            file=join(self.abs_path, r'Data\Resources2\minus.png'))
        self.tree_empty = PhotoImage(
            file=join(self.abs_path, r'Data\Resources2\empty.png'))
