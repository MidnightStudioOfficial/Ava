...
class WidgetTree(ttk.Frame):
    def __init__(self: ttk.Frame, parent: object, disallowed_windows: list, abs_path: str) -> ttk.Frame:
        ...
        self.icons: dict = {
            'Tk': PhotoImage(file=join(self.abs_path, r'Data\Resources2\app.png')),
            'TFrame': PhotoImage(file=join(self.abs_path, r'Data\Resources2\frame.png')),
            'TButton': PhotoImage(file=join(self.abs_path, r'Data\Resources2\button.png')),
            'TLabel': PhotoImage(file=join(self.abs_path, r'Data\Resources2\label.png')),
            'TEntry': PhotoImage(file=join(self.abs_path, r'Data\Resources2\entry.png')),
            'TRadiobutton': PhotoImage(file=join(self.abs_path, r'Data\Resources2\radiobutton.png')),
            'TCombobox': PhotoImage(file=join(self.abs_path, r'Data\Resources2\combobox.png')),
            'TScale': PhotoImage(file=join(self.abs_path, r'Data\Resources2\scale.png')),
