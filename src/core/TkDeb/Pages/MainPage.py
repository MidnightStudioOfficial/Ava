...
class MainPage(ttk.Frame):
    def __init__(self: ttk.Frame, parent: object, props: dict) -> ttk.Frame:
        ...
        self.icons = {
            'inspect': [PhotoImage(file=join(self.abs_path, r'Data\Resources2\start_inspection.png')), PhotoImage(file=join(self.abs_path, r'Data\Resources2\end_inspection.png'))],
            'widgets': PhotoImage(file=join(self.abs_path, r'Data\Resources2\widgets.png')),
            'pin': [PhotoImage(file=join(self.abs_path, r'Data\Resources2\pin.png')), PhotoImage(file=join(self.abs_path, r'Data\Resources2\unpin.png'))],
            'delete': PhotoImage(file=join(self.abs_path, r'Data\Resources2\delete.png')),
        }
