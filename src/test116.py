...
def main():
    ...
    animate_window_down(window1, 0, screen_height - 200, duration=2.0, easing_func=linear_ease)
    window1.title("linear_ease")
    animate_window_down(window2, 0, screen_height - 200, duration=2.0, easing_func=ease_in_quad)
    window2.title("ease_in_quad")
    animate_window_down(window3, 0, screen_height - 200, duration=2.0, easing_func=ease_out_quad)
    window3.title("ease_out_quad")
    animate_window_down(window4, 0, screen_height - 200, duration=1.0, easing_func=ease_in_out_cubic)
