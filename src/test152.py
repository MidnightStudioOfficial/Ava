...
class ReferencingClassifier2:
    ...
    def __init__(self) -> None:
        ...
        self.labeled_data = [
            ...
            ("I'm not sure what to do", "user"),
            ("Can you rephrase that?", "chatbot"),
        ]
        # Separate the input (X) and labels (y)
        self.X, self.y = zip(*self.labeled_data)
...
m2 = ReferencingClassifier2()
m.train()
m2.train()
while True:
    i = input("you:")
    print(m.predict(str(i)))
    print(m2.predict(str(i)))